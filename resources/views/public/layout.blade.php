...
<html lang="fr">
    <head>
        ...
        <meta property="og:image" content="{{ asset('images/logo/alu-la-solution-full.webp') }}">
        <meta property="og:image:alt" content="{{ config('business.name') }} - Menuiserie aluminium et vitrerie à Lomé">
        ...
        <meta name="twitter:image" content="{{ asset('images/logo/alu-la-solution-full.webp') }}">
        <meta name="twitter:image:alt" content="{{ config('business.name') }} - Menuiserie aluminium et vitrerie à Lomé">
        <link rel="canonical" href="{{ trim($__env->yieldContent('canonical')) ?: url()->current() }}">
        <link rel="alternate" hreflang="fr-TG" href="{{ url()->current() }}">
        ...
        @php
            ...
            $schema = [
                ...
                'priceRange' => '$$$',
                'image' => asset('images/logo/alu-la-solution-full.webp'),
                'logo' => asset('images/logo/alu-la-solution-full.webp'),
                'sameAs' => ['https://wa.me/'.config('business.phone_digits')],
            ];
        ...
        <div class="min-h-screen bg-[radial-gradient(circle_at_top,_rgba(251,191,36,0.15),_transparent_35%)]">
            <header class="sticky top-0 z-50 border-b border-slate-200/70 bg-white/75 backdrop-blur-xl shadow-[0_10px_30px_rgba(15,23,42,0.04)]">
                <nav class="mx-auto flex max-w-6xl items-center justify-between px-4 py-3 sm:px-6 lg:grid lg:grid-cols-[1fr_auto_1fr] lg:px-8">
                    ...
                    <div class="hidden items-center gap-6 text-sm font-medium text-slate-600 lg:flex lg:justify-self-center">
